...
import {
  calculateCustomGeneSetActivity,
  createMeanMap,
...
describe('Analysis Service Test', () => {
  ...
  it('Create mean map', () => {
    const returnMap = createMeanMap([TEST_ANALYZED_DATA_COHORT_A,TEST_ANALYZED_DATA_COHORT_B])
  ...
  it('Calculate custom gene ', () => {
    const outputData =  calculateCustomGeneSetActivity(TEST_GMT_DATA,[TEST_ANALYZED_DATA_COHORT_A,TEST_ANALYZED_DATA_COHORT_B])
  })
})
