...
export default class XenaGeneSetApp extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      sortViewBy: urlVariables.geneSetFilterMethod ?urlVariables.geneSetFilterMethod : SORT_ENUM.DIFF,
      filterOrder: SORT_ORDER_ENUM.DESC,
      filterBy: urlVariables.geneSetSortMethod ?urlVariables.geneSetSortMethod :SORT_ENUM.CONTRAST_DIFF,
      filter: filter,
