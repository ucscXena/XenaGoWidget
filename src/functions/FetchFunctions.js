...
export function fetchCombinedCohorts(selectedCohorts, pathways,filter, combinationHandler) {
  ...
  Rx.Observable.zip(
    ...
    return Rx.Observable.zip(
      ...
      datasetFetch(selectedCohorts[0].paradigm.host, selectedCohorts[0].paradigm.dataset, samplesA, geneSetLabels),
      ...
      datasetFetch(selectedCohorts[1].paradigm.host, selectedCohorts[1].paradigm.dataset, samplesB, geneSetLabels),
